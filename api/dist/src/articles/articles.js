...
* [Pt 6 New project emmet, html doc, label, inputHtml, Emmet label input](https://raw.github.com/lewislwood/nfbcs-vscode-presentation/master/media/Pti_6_New_project_emmet_html_doc_label_inputHtml_Emmet_label_input.mp3)
...
const initArticles = async () => {
    exports.articles.forEach(async (a, i) => {
        a.html = await marked_1.marked.parse(a.markdown);
        a.id = i + 1;
    });
